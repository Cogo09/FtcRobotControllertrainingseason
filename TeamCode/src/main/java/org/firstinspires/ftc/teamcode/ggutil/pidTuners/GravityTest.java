...
import static org.firstinspires.ftc.teamcode.ggutil.pidTuners.TuningOpModes.gravityMotorPower;
...
import com.dacodingbeast.pidtuners.Opmodes.TestingSize;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(motor.getClass() == ArmMotor.class){
                target = (TuningOpModes.angleRange.getStop());
                run = !motor.targetReached(target,15.0);
            }else {
                // TODO
