...
public final class PIDTuning {
    ...
    static double frictionRPMs = 590;
    static PIDParams pidParamss = new PIDParams(2.5512300962739993, 0.023279063946885614, 0.45811517326219553, 0.0);
...
//        static SlideRange slideRange = SlideRange.fromCM(0.0,30);
    static SlideSystemConstants slideSystemConstants = new SlideSystemConstants(5821.82, frictionRPMs);
...
//    static PIDParams pidParams = new PIDParams(0.01,0.0,0.0,0.0);
