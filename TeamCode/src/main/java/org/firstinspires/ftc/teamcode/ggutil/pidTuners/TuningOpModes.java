...
public final class TuningOpModes {
    ...
    static AngleRange obstacleAngle = AngleRange.Angles.fromDegrees(91, 350);
    static AngleRange testingAngle = AngleRange.Angles.fromDegrees(0, 90);
    ...
    public static ArmMotor armMotor = new ArmMotor("Shoulder", DcMotorSimple.Direction.FORWARD, Hardware.YellowJacket.RPM435, pivotSystemConstants, 1.0, pidParams, testingAngle.asArrayList(), null, obstacleAngle);
